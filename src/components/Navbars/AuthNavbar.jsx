          ...
          >
            <ul className='flex flex-col lg:flex-row list-none mr-auto'>
              <li className='flex items-center'>
                ...
                >
                  <FontAwesomeIcon
                    className='lg:text-slate-200 text-slate-400 far fa-file-alt text-lg leading-lg mr-2'
                    icon={faFileLines}
                  />
                  Docs
                </a>
            ...
            <ul className='flex flex-col lg:flex-row list-none lg:ml-auto'>
              ...
              <li className='flex items-center'>
                ...
                >
                  <FontAwesomeIcon
                    icon={faFacebook}
                    className='lg:text-slate-200 text-slate-400 fab fa-facebook text-lg leading-lg '
                  />
              ...
              <li className='flex items-center'>
                ...
                >
                  <FontAwesomeIcon
                    icon={faTwitter}
                    className='lg:text-slate-200 text-slate-400 fab fa-twitter text-lg leading-lg '
                  />
              ...
              <li className='flex items-center'>
                ...
                >
                  <FontAwesomeIcon
                    icon={faGithub}
                    className='lg:text-slate-200 text-slate-400 fab fa-github text-lg leading-lg '
                  />
