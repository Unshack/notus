          ...
          >
            <ul className='flex flex-col lg:flex-row list-none mr-auto'>
              <li className='flex items-center'>
                ...
                >
                  <FontAwesomeIcon
                    className='text-slate-400 far fa-file-alt text-lg leading-lg mr-2'
                    icon={faFileLines}
                  />
                  Docs
                </a>
            ...
            <ul className='flex flex-col lg:flex-row list-none lg:ml-auto'>
              ...
              <li className='flex items-center'>
                <a
                  className='hover:test-slate-500 text-slate-700 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold'
                ...
                >
                  <FontAwesomeIcon
                    icon={faFacebook}
                    className='text-slate-400 fab fa-facebook text-lg leading-lg'
                  />
              ...
              <li className='flex items-center'>
                ...
                >
                  <FontAwesomeIcon
                    icon={faTwitter}
                    className='text-slate-400 fab fa-twitter text-lg leading-lg '
                  />
              ...
              <li className='flex items-center'>
                ...
                >
                  <FontAwesomeIcon
                    icon={faGithub}
                    className='text-slate-400 fab fa-github text-lg leading-lg '
                  />
