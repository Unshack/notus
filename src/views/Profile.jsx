              ...
              <div className='px-6'>
                ...
                <div className='text-center mt-12'>
                  ...
                  <div className='text-sm leading-normal mt-0 mb-2 text-slate-400 font-bold uppercase'>
                    <FontAwesomeIcon
                      icon={faLocationDot}
                      className='fas fa-map-marker-alt mr-2 text-lg text-slate-400'
                    />
                  ...
                  <div className='mb-2 text-slate-600 mt-10'>
                    <FontAwesomeIcon
                      icon={faBriefcase}
                      className='fas fa-briefcase mr-2 text-lg text-slate-400'
                    />
                  ...
                  <div className='mb-2 text-slate-600'>
                    <FontAwesomeIcon
                      ...
                      className='fas fa-university mr-2 text-lg text-slate-400'
                    />
